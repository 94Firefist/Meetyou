...
{
	private String group_id, member_id, citype_id, public_gr, public_grl, public_gra, group_memberCount,
			group_eventCount;
	...
	public String getGroup_memberCount()
	{
		return group_memberCount;
	}

	public void setGroup_memberCount(String group_memberCount)
	{
		this.group_memberCount = group_memberCount;
	}

	public String getGroup_eventCount()
	{
		return group_eventCount;
	}

	public void setGroup_eventCount(String group_eventCount)
	{
