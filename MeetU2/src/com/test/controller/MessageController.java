...
public class MessageController
{
	...
	public ModelAndView messageMyreceive(HttpServletRequest request, HttpSession session) throws ClassNotFoundException, SQLException
	{
		...
		ArrayList<com.test.dto.ReceiveMessageDTO> receiveMsgList = new ArrayList<com.test.dto.ReceiveMessageDTO>();
		...
		//메시지 리스트를 받을 리스트 변수 
		ArrayList<com.test.dto.Message_DTO> receiveMsgDtos = new ArrayList<com.test.dto.Message_DTO>();
		
		
		for(com.test.dto.ReceiveMessageDTO dto : receiveMsgList) {
	...
	public ModelAndView messageMysent(HttpServletRequest request, HttpSession session) throws ClassNotFoundException, SQLException
	{
		...
		ArrayList<com.test.dto.Message_DTO> sendMsgList = dao.sendMsgList(hashmap );
	...
	public ModelAndView messageMysentForm(HttpServletRequest request) throws ClassNotFoundException, SQLException
	{
		...
		com.test.dto.Message_DTO sendMsg = dao.getsendMsg(lmbtextsend_id);
