...
public interface EventIDAO
{
	...
	public ArrayList<EEventDTO> groupList(String keynumber);		// 현재 그룹장이거나, 운영진 인 그룹 리스트
	public ArrayList<EEventDTO> evepublicList();					// 이벤트 공개범위 리스트
	public ArrayList<EEventDTO> categoryList();					// 카테고리 리스트
