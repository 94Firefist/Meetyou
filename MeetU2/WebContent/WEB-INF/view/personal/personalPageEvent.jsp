...
<body>
	...
	<div class='container' style="width: 100%;">
		...
		<!-- 메인 메뉴 -->
		<div class='span8 main w3-row' style="width: 1130px; background-color: white;">
         
			<div class="" style="border-right: 2px solid #ccc; width: 100%; padding: 2%;">
						...
						<div class="bottomLine" style="width: 100%; height: 40%; padding: 1%;">
							...
							<c:if test="${keynumber != null }">
								<div style="width: 20%; height: 100%; float:left; text-align: right;">
									<span class="glyphicon glyphicon-exclamation-sign" aria-hidden="true"  style="color: blue; font-size: 15px; text-align: right;"onclick="reportPopup();">
										신고
									</span>
								</div>
							</c:if>
					...
					<div class="" style="width: 100%; height: 20%; padding: 2%; position: static;">
						...
						<div style="width: 50%; height: 100%; float: left; text-align: center;">
							...
							<p id="eventAttendance" style="float: left; font-size: 23px;">
								&nbsp;${eventInfo.attend_count}/${eventInfo.event_maxAttend} 참석
							</p>
